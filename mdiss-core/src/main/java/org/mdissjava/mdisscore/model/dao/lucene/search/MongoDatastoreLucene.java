...
public class MongoDatastoreLucene {

	   DB db;

	   public MongoDatastoreLucene() throws UnknownHostException, MongoException {
	       Mongo m = new Mongo( "localhost" , 27017 );
	       m.dropDatabase("busquedaLucene");
	       db = m.getDB("busquedaLucene");
	   }
